...
![[system 2025.excalidraw]]

| Name        | Desc                                                                               | Example            |
| ----------- | ---------------------------------------------------------------------------------- | ------------------ |
| system(SSI) | 通用Android系统组件，原则上不同厂商、不同型号的设备都通用                          | Android            |
| vendor      | 厂商对系统的定制，例如高通对Android系统附加的功能，包括一些闭源的程序等            | Qcom/Mtk           |
| odm         | 可选的分区，包含SOC附加的程序，这些内容可以集成在vendor中，也可以单独分离出odm分区 | xm/oppo/vivo       |
| product     | 与特定产品有关的模块，包括对于Android系统的定制化                                  | xiaomi 14/15...... |
