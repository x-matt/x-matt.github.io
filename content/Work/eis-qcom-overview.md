...
Qcom-EIS supported sensor: FRONT, WIDE, ULTRA-WIDE, TELE
...
- [QIS](https://docs.qualcomm.com/bundle/80-PN984-102/resource/80-PN984-102.pdf)
  - Qcom image stabilization
  - 包含 stabilization, LDC, OIS

### 3.2 DIS

- 基于图像的防抖 (digital image stabilization)

### 3.3 GME (Gyro Motion Estimate)

- Doc:
  [EIS 3rd Party algorithm integration Guide](https://docs.qualcomm.com/bundle/KBA-211010195120/resource/KBA-211010195120.pdf)
- Output:
  1. the distortion correction grid includes rolling shutter
  2. MCTF alignment for current frame
- Can be used under photo mode separately
...
### 10.1 EVA (Engine for Visual Analytics)
...
- motion compensated temporal-filtering，运动补偿时域滤波
